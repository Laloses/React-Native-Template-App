...
export default class API {
  ...
  login = async (user, pass) => {
    try {
      let res = null;
      let req = await fetch(`${this.base_url_server}/loginMultiuser.do`, {
        method: 'POST',
        body: JSON.stringify({
          User: user,
          Password: pass,
                  ...
                  children: [
                    {
                      ...
                      children: [
                        ...
                        },
                        {
                          ...
                          type: 'Organism',
                          description:
                            'Domestic breed of cats, of oriental origin',
                          children: [],
                        },
                      ],
                    },
                    {
                      ...
                      children: [
                        ...
                        },
                        {
                          ...
                          type: 'Organism',
                          description:
                            'Spotted bear native to South Central China',
                          children: [],
                        },
                      ],
                    },
                      ...
                      children: [
                        {
                          ...
                          type: 'Organism',
                          description:
                            'One of the most popular dog breeds in Canada, UK and USA',
                          children: [],
                        },
                        {
                          id: 11,
                          ...
                          type: 'Organism',
                          description:
                            'Generally friendly, loyal and intelligent breed of dogs',
                          children: [],
                        },
                      ],
                    },
                  ...
                  children: [
                    {
                      ...
                      children: [
                        ...
                        },
                        {
                          ...
                          type: 'Organism',
                          description:
                            'Known as the highest-production dairy animals',
                          children: [],
                        },
                      ],
                    },
                      ...
                      children: [
                        {
                          ...
                          type: 'Organism',
                          description:
                            'A breed of Northern African horses with high stamina and hardiness. Their generally hot temperament makes it harder to tame.',
                          children: [],
                        },
                        {
                          id: 18,
                          ...
                          type: 'Organism',
                          description:
                            'One of the oldest of warmblood breeds, tracing back to the 13th century. Originates from Germany',
                          children: [],
                        },
                      ],
                    },
                      ...
                      children: [
                        {
                          ...
                          type: 'Organism',
                          description:
                            "Unusual rabbit with a wool mane circling it's head, similar to a lion, hence it's name.",
                          children: [],
                        },
                        {
                          id: 21,
